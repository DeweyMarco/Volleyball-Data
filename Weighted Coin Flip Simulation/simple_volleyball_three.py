...
def experiment():
    ...
    print("projected 2 - 0 games : " + str(sets_played[0] / trials))
    print("projected 2 - 1 games : " + str(sets_played[1] / trials))
    print("projected 1 - 2 games : " + str(sets_played[2] / trials))
    print("projected 0 - 2 games : " + str(sets_played[3] / trials))
...
def read_input():
    ...
    if len(sys.argv) != 5:
        ...
        print()
        print("python3 simple_volleyball_three.py [number of trials] [season length] [post season threshold] [win percentage]")
        print()
        print("Example : $ python3 simple_volleyball_three.py 1000 20 12 0.52")
        exit()
